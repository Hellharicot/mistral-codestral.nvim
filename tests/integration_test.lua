...
test("API key authentication", function()
	...
	-- Note: Test key length varies, production keys are typically 32 chars
	assert(#key >= 8, "API key too short")
end)
...
test("User commands", function()
	...
	-- Note: Auth command is created by auth module setup, which is not called by default
